...
class Doctor(models.Model):
    doctor_id = models.CharField(default=randomId(), max_length=10, null=True)
...
class Patient(models.Model):
    ...
    patient_id = models.CharField(default=randomId(),  max_length=10, null = True)
    owner = models.OneToOneField(User, null=True, on_delete=models.CASCADE)
    image = models.CharField(max_length=50, null=True, blank=True)
    surname = models.CharField(max_length=50, null=True)
    other_names = models.CharField(max_length=50, null=True)
...
class Records(models.Model):
    ...
    record_id = models.CharField(default=randomId(), max_length=10)
    owner = models.CharField(null=True, blank=True, max_length=50)
    symptoms = models.TextField(null=True, blank=True)
    description = models.TextField(null=True, blank=True)
    doctor = models.CharField(null=True, blank=True, max_length=50)
